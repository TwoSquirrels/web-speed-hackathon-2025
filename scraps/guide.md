...
| ファイル | 内容 |
|---------|------|
| [checklist.md](./checklist.md) | 競技中に上から順に実行する実践手順書 |
| [traps.md](./traps.md) | 失格・罠パターン集 + 毎年仕込まれる罠テーブル |
| [years.md](./years.md) | 年度別のアプリ詳細・仕込み問題 |
| [guide.md](./guide.md) | 概要・スコア計算式・戦略・メトリクス解説・ツールリファレンス (このファイル) |
...
**⚠️ 重要な条件**: ①のページ表示スコアが **200 点以上** でないと②③が 0 点になる。
